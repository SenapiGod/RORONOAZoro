...
PM_START_TEXT = """
ʜᴇʏ[,](https://telegra.ph/file/8d66028f1000fc972b247.jpg)
✪ ᴛʜɪs ɪs {} !
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", callback_data="Ft999_eXe"
                        ),
                        InlineKeyboardButton(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/ItAchixoBot_Support"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="ᴅᴇᴠᴇʟᴏᴩᴇʀ", url="https://t.me/Invincible_itAchi"
                        ),
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ", url="https://github.com/Aftrr"
                        ),
                    ],
                    [
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                f"@{SUPPORT_CHAT}",
                "https://telegra.ph/file/8d66028f1000fc972b247.jpg",
                caption="ʀᴏʀᴏɴᴏᴀ ᴢᴏʀᴏ ɪs ᴀʟɪᴠᴇ! ",
            )
        except Unauthorized:
            LOGGER.warning(
